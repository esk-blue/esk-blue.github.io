export const siteConfig = {
  ...
  aboutMe:
    "저는 서울사이버대학교에서 인공지능을 전공하고 있으며,</p><p> 회사에서 냉난방설비 유지보수 엔지니어로 근무하고 있습니다.</p><p>실제 산업 시스템의 운영과 문제 진단을 경험했으며, 인공지능 기술을 활용해 현장 문제 해결 능력을 극대화하고 </p><p>실질적인 혁신을 이루는 것이 목표입니다 ",
